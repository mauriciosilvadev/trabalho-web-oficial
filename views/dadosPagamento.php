                    ...
                    <div class="row g-3">
                            ...
                            <div class="card h-100 payment-option">
                                <div class="card-body text-center p-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pag" value="boleto" id="boleto" required>
                        ...
                        <div class="col-md-6">
                            <div class="card h-100 payment-option">
                                <div class="card-body text-center p-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pag" value="crédito" id="credito">
                        ...
                        <div class="col-md-6">
                            <div class="card h-100 payment-option">
                                <div class="card-body text-center p-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pag" value="debito" id="debito">
                        ...
                        <div class="col-md-6">
                            <div class="card h-100 payment-option">
                                <div class="card-body text-center p-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pag" value="pix" id="pix">
...
.payment-option .form-check-input:checked ~ .card {
    border-color: #007bff;
    background-color: #f8f9ff;
}
</style>
