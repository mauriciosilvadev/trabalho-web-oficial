...
<center>
      <h2>
            <font face="Arial">Opção de Pagamento</font>
      </h2>
      <p>
      ...
      <form action="../controllers/controllerVenda.php" method="get">
            <input type="radio" name="pag" value="boleto" required> Boleto Bancário<p>
                  <input type="radio" name="pag" value="crédito"> Cartão de Crédito
            <p>
                  <input type="radio" name="pag" value="debito"> Cartão de Débito
            <p>
